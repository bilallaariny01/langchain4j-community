# LangChain4j Community Oracle Spring Boot Starter
...
<dependency>
    ...
    <artifactId>langchain4j-community-oracle-spring-boot-starter</artifactId>
...
```bash
mvn -pl spring-boot-starters/langchain4j-community-oracle-spring-boot-starter \
